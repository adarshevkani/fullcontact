...
// user search
   add_action('wp_ajax_fetch_users', 'fetch_users');
	add_action('wp_ajax_nopriv_fetch_users', 'fetch_users');
		...
		$return_str = get_template_part('template-parts/search/search', 'list');
		die($return_str);
	}
...
// user Delete
   add_action('wp_ajax_delete_user', 'delete_user');
	add_action('wp_ajax_nopriv_delete_user', 'delete_user');
		...
		$return_str = get_template_part('template-parts/delete/delete', 'list');
		die($return_str);
	}


// user api
   add_action('wp_ajax_fetch_userData', 'fetch_userData');
	add_action('wp_ajax_nopriv_fetch_userData', 'fetch_userData');
